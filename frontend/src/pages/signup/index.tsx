        ...
        >
            ...
            >
                {registeredEmail ? (
                    ...
                    >
                        <Title order={2} ta="center" mb={5} style={{ color: '#2d3319', fontWeight: 700, fontSize: '28px' }}>
                            Check your inbox 📬
                        </Title>
                        <Text size="sm" ta="center" c="dimmed" mb="xl" style={{ color: '#5a6b4f' }}>
                            We sent a verification link to <strong>{registeredEmail}</strong>. Click it to activate your account before logging in.
                        </Text>
                        {resendSuccess ? (
                            <Text size="sm" ta="center" c="green">Verification email resent!</Text>
                        ) : (
                            <Button
                                fullWidth
                                variant="outline"
                                ...
                                onClick={() => resend(registeredEmail, { onSuccess: () => setResendSuccess(true) })}
                            >
                                Resend verification email
                            </Button>
                        )}
                        <Text size="sm" ta="center" mt="md">
                            <Anchor style={{ color: '#97A97C' }} onClick={() => navigate({ to: '/login' })}>
                                Back to Login
                            </Anchor>
                        </Text>
                    </Paper>
                                ...
                                <Box mb="md">
                                    {passwordRules.map((rule) => (
                                        <Text
                                            key={rule.label}
                                            size="xs"
                                            style={{ color: rule.test(password) ? '#6b7c5e' : '#aaa' }}
                                        >
